...
本项目是一个基于Ursina引擎开发的适用于辅助教学（特别是人教版8年级上册地理教科书-束水攻沙）的模拟演示程序，旨在直观展示"束水攻沙"这一传统水利工程原理。程序通过3D可视化方式模拟河流流动及泥沙沉积过程，用户可调节河宽、河高和泥沙量等参数，观察不同条件下的水流与泥沙运动规律。
...
*注：公式中的900为流量，来源于人教版8年级上册地理教科书假定值。公式中的7是一个经验值，用于调整水流速度与河宽、河高的关系。
